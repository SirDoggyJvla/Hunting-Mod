...
--- Brita
	...
	["Base.40HERound"                         ]	=	{ AmmoType = "Bullet" ,	Emin = 20000,	Emax = 20000,	Diameter =  40.0,	CanKill = true, },
	["Base.40INCRound"                        ]	=	{ AmmoType = "Bullet" ,	Emin = 15000,	Emax = 16000,	Diameter =  40.0,	CanKill = true, },
	...
	["Base.SlingShotAmmo_Rock"                ]	=	{ AmmoType = "Other"  ,	Emin =     0,	Emax =     5,	Diameter =  20.0,	CanKill = true, },
	["Base.SlingShotAmmo_Marble"              ]	=	{ AmmoType = "Other"  ,	Emin =     0,	Emax =     5,	Diameter =  20.0,	CanKill = true, },
...
--- Pallontras Weapons
	["PWPNXB.WoodBolt"                        ]	=	{ AmmoType = "Other"  ,	Emin =   150,	Emax =   350,	Diameter =  7.62,	CanKill = true, },
	["PWPNXB.ShortWoodBolt"                   ]	=	{ AmmoType = "Other"  ,	Emin =   100,	Emax =   300,	Diameter =  7.62,	CanKill = true, },
	["PWPNXB.ShortIronBolt"                   ]	=	{ AmmoType = "Other"  ,	Emin =   150,	Emax =   350,	Diameter =  7.62,	CanKill = true, },
	["PWPNXB.IronBolt"                        ]	=	{ AmmoType = "Other"  ,	Emin =   200,	Emax =   400,	Diameter =  7.62,	CanKill = true, },
...
--- Scrap Guns
	["SGuns.MetalScraps"                      ]	=	{ AmmoType = "Bullet" ,	Emin =   140,	Emax =   280,	Diameter =   3.0,	CanKill = true, },
...
--- Advanced Warfare EX
	...
	["Base.CarbonFibre_Arrow"                 ]	=	{ AmmoType = "Other"  ,	Emin =   150,	Emax =   350,	Diameter =  7.62,	CanKill = true, },
	["Base.WoodenStick"                       ]	=	{ AmmoType = "Other"  ,	Emin =   150,	Emax =   350,	Diameter =  7.62,	CanKill = true, },
...
--- EscapeFromKentucky2
	...
	["Base.bolt"                              ]	=	{ AmmoType = "Other"  ,	Emin =   200,	Emax =   400,	Diameter =  7.62,	CanKill = true, },
	["Base.Bullets308"                        ]	=	{ AmmoType = "Bullet" ,	Emin =  2500,	Emax =  3800,	Diameter =  7.82,	CanKill = true, },
	["Base.Nails"                             ]	=	{ AmmoType = "Bullet" ,	Emin =   140,	Emax =   280,	Diameter =   3.0,	CanKill = true, },
	["Base.GrenadeAmmo"                       ]	=	{ AmmoType = "Bullet" ,	Emin = 20000,	Emax = 20000,	Diameter =  40.0,	CanKill = true, },

--- Crossbow (Lactose)
	["LactoseCrossbow.LCCrossbowBoltAluminium"]	=	{ AmmoType = "Other"  ,	Emin =   150,	Emax =   350,	Diameter =  7.62,	CanKill = true, },
	["LactoseCrossbow.CrossbowBolt"           ]	=	{ AmmoType = "Other"  ,	Emin =   150,	Emax =   350,	Diameter =  7.62,	CanKill = true, },
